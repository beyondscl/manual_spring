...
public class MysqlConnPool {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3306/yuese?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true";
